<template>
  ...
  <div class="container">
    <div class="top-line d-flex align-items-center flex-wrap">
      <div class="left d-flex flex-wrap">
        <div class="click-btn d-flex justify-content-center align-items-center add-btn">
  ...
  <table class="table table-striped mt-5">
    ...
    <tr>
      <th scope="col">#</th>
      <th scope="col">Время удаления</th>
      <th scope="col">Имя обьекта</th>
      <th scope="col">Учётная запись</th>
      <th scope="col">Тип обьекта</th>
